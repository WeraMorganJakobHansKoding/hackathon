...
<div id="tileBox" class="yearWrapper year{$year@key}">
	...
	<div class="tile green military" id="" data-lapse="{$year.military.lapse}">
	...
	<div class="tile baby education" id="" data-lapse="{$year.education.lapse}">
	...
	<div class="tile orange population" id="" data-lapse="{$year.population_growth.lapse}">
	...
	<div class="tile pink tourism" id="" data-lapse="{$year.tourists.lapse}">
	...
	<div class="tile yellow coal" id="" data-lapse="{$year.coal_energy.lapse}">
	...
	<div class="tile teal forests" id="teal" data-lapse="{-1 * $year.forests_growth.lapse}">
    {else}
    <div class="tile teal forests" id="teal" data-lapse="{$year.forests_growth.lapse}">
    {/if}
